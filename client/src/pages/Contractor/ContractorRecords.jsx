...
const RENTERS = [
  {
    id: 1, name: "Juan Dela Cruz", phone: "+63 917 123 4567", stall: "Stall #042",
    status: "active", lastPayment: "Oct 1, 2023", amountDue: "₱3,500", since: "Jan 2021", initials: "JD",
    history: [
      { date: "Oct 1, 2023", amount: "₱3,500", status: "paid" },
      { date: "Sep 1, 2023", amount: "₱3,500", status: "paid" },
      { date: "Aug 1, 2023", amount: "₱3,500", status: "paid" },
    ],
  },
  {
    id: 2, name: "Maria Clara", phone: "+63 928 987 6543", stall: "Stall #015",
    status: "late_payment", lastPayment: "Aug 1, 2023", amountDue: "₱7,000", since: "Mar 2022", initials: "MC",
    history: [
      { date: "Aug 1, 2023", amount: "₱3,500", status: "paid" },
      { date: "Sep 1, 2023", amount: "₱3,500", status: "unpaid" },
      { date: "Oct 1, 2023", amount: "₱3,500", status: "unpaid" },
    ],
  },
  {
    id: 3, name: "Antonio Luna", phone: "+63 945 444 2222", stall: "Stall #109",
    status: "long_overdue", lastPayment: "Jun 1, 2023", amountDue: "₱17,500", since: "Nov 2020", initials: "AL",
    history: [
      { date: "Jun 1, 2023", amount: "₱3,500", status: "paid" },
      { date: "Jul 1, 2023", amount: "₱3,500", status: "unpaid" },
      { date: "Aug 1, 2023", amount: "₱3,500", status: "unpaid" },
      { date: "Sep 1, 2023", amount: "₱3,500", status: "unpaid" },
      { date: "Oct 1, 2023", amount: "₱3,500", status: "unpaid" },
    ],
  },
  {
    id: 4, name: "Elena Garcia", phone: "+63 905 555 1234", stall: "Stall #088",
    status: "active", lastPayment: "Oct 1, 2023", amountDue: "₱3,500", since: "Jun 2022", initials: "EG",
    history: [
      { date: "Oct 1, 2023", amount: "₱3,500", status: "paid" },
      { date: "Sep 1, 2023", amount: "₱3,500", status: "paid" },
    ],
  ...
  {
    id: 5, name: "Ricardo Santos", phone: "+63 912 777 8888", stall: "Stall #055",
    status: "active", lastPayment: "Oct 1, 2023", amountDue: "₱3,500", since: "Feb 2021", initials: "RS",
    history: [
      { date: "Oct 1, 2023", amount: "₱3,500", status: "paid" },
      { date: "Sep 1, 2023", amount: "₱3,500", status: "paid" },
      { date: "Aug 1, 2023", amount: "₱3,500", status: "paid" },
  ...
  {
    id: 6, name: "Corazon Reyes", phone: "+63 933 222 5566", stall: "Stall #067",
    status: "late_payment", lastPayment: "Sep 1, 2023", amountDue: "₱3,500", since: "Apr 2023", initials: "CR",
    history: [
      { date: "Sep 1, 2023", amount: "₱3,500", status: "paid" },
      { date: "Oct 1, 2023", amount: "₱3,500", status: "unpaid" },
    ],
...
export default function ContractorRecords() {
  ...
  const activePct = Math.round((activeCount / totalRenters) * 100);
